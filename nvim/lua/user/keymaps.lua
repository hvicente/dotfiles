...
keymap("n", "<silent> <Leader>b", "<Cmd>lua require'dap'.toggle_breakpoint()<CR>", opts)
-- keymap("n", "<silent> <Leader>B", "<Cmd>lua require'dap'.continue()<CR>",opts)
-- keymap("n", "<silent> <Leader>lp", "<Cmd>lua require'dap'.continue()<CR>",opts)
-- keymap("n", "<silent> <Leader>dr", "<Cmd>lua require'dap'.continue()<CR>",opts)
-- keymap("n", "<silent> <Leader>dl", "<Cmd>lua require'dap'.continue()<CR>",opts)
